 ...
 *
 * This function copies global settings from the default virtual host to a specific vhost.
 * These settings cannot be overridden at the vhost level and are applied uniformly
